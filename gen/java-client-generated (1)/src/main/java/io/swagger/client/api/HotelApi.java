...
public class HotelApi {
    ...
    public com.squareup.okhttp.Call deleteRoomByIdCall(Integer hotelId, Integer roomId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/hotels/{hotel_id}/{room_id}"
            .replaceAll("\\{" + "hotel_id" + "\\}", apiClient.escapeString(hotelId.toString()))
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getHotelsCall(Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getHotelsValidateBeforeCall(Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'page' is set
        if (page == null) {
            throw new ApiException("Missing the required parameter 'page' when calling getHotels(Async)");
        }
        // verify the required parameter 'pageSize' is set
        if (pageSize == null) {
            throw new ApiException("Missing the required parameter 'pageSize' when calling getHotels(Async)");
        }
        
        com.squareup.okhttp.Call call = getHotelsCall(page, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Hotel> getHotels(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<List<Hotel>> resp = getHotelsWithHttpInfo(page, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Hotel>> getHotelsWithHttpInfo(Integer page, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getHotelsValidateBeforeCall(page, pageSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getHotelsAsync(Integer page, Integer pageSize, final ApiCallback<List<Hotel>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getHotelsValidateBeforeCall(page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Hotel>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getHotelsByLocationCall(String location, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/hotels/{location}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getHotelsByLocationValidateBeforeCall(String location, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'page' is set
        if (page == null) {
            throw new ApiException("Missing the required parameter 'page' when calling getHotelsByLocation(Async)");
        }
        // verify the required parameter 'pageSize' is set
        if (pageSize == null) {
            throw new ApiException("Missing the required parameter 'pageSize' when calling getHotelsByLocation(Async)");
        }
        
        com.squareup.okhttp.Call call = getHotelsByLocationCall(location, page, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Hotel> getHotelsByLocation(String location, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<List<Hotel>> resp = getHotelsByLocationWithHttpInfo(location, page, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Hotel>> getHotelsByLocationWithHttpInfo(String location, Integer page, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getHotelsByLocationValidateBeforeCall(location, page, pageSize, null, null);
        Type localVarReturnType = new TypeToken<List<Hotel>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getHotelsByLocationAsync(String location, Integer page, Integer pageSize, final ApiCallback<List<Hotel>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getHotelsByLocationValidateBeforeCall(location, page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Hotel>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getRoomsCall(Integer hotelId, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getRoomsValidateBeforeCall(Integer hotelId, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'hotelId' is set
        if (hotelId == null) {
        ...
        // verify the required parameter 'page' is set
        if (page == null) {
            throw new ApiException("Missing the required parameter 'page' when calling getRooms(Async)");
        }
        // verify the required parameter 'pageSize' is set
        if (pageSize == null) {
            throw new ApiException("Missing the required parameter 'pageSize' when calling getRooms(Async)");
        }
        
        com.squareup.okhttp.Call call = getRoomsCall(hotelId, page, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Room> getRooms(Integer hotelId, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<List<Room>> resp = getRoomsWithHttpInfo(hotelId, page, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Room>> getRoomsWithHttpInfo(Integer hotelId, Integer page, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getRoomsValidateBeforeCall(hotelId, page, pageSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRoomsAsync(Integer hotelId, Integer page, Integer pageSize, final ApiCallback<List<Room>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRoomsValidateBeforeCall(hotelId, page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Room>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
